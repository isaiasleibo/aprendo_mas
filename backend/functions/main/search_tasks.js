...
module.exports = async (event, res) => {
    ...
    try {
        ...
        const { id_alumno, id_curso, page = 1, limit = 10 } = event.body || {};
        ...
        // Obtener las materias en las que el alumno está registrado
        ...
        // Obtener publicaciones tipo "tarea" filtradas por curso y materias del alumno
        const [publicaciones] = await pool.query(`
            ...
            WHERE p.id_curso = ? AND p.tipo = 'tarea' AND p.id_materia IN (${placeholders})
